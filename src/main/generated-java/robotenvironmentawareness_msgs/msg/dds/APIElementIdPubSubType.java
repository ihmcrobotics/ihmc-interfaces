...
public class APIElementIdPubSubType implements us.ihmc.pubsub.TopicDataType<robotenvironmentawareness_msgs.msg.dds.APIElementId>
{
    ...
    @Override
   public void serialize(robotenvironmentawareness_msgs.msg.dds.APIElementId data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, robotenvironmentawareness_msgs.msg.dds.APIElementId data) throws java.io.IOException
   {
   ...
   public static void write(robotenvironmentawareness_msgs.msg.dds.APIElementId data, us.ihmc.idl.CDR cdr)
   {
	    ...
	    cdr.write_type_e(data.getId());else
