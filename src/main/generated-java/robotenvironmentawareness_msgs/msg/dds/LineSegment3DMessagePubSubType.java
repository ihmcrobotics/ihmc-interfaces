...
public class LineSegment3DMessagePubSubType implements us.ihmc.pubsub.TopicDataType<robotenvironmentawareness_msgs.msg.dds.LineSegment3DMessage>
{
   ...
   public static void staticCopy(robotenvironmentawareness_msgs.msg.dds.LineSegment3DMessage src,
                                 robotenvironmentawareness_msgs.msg.dds.LineSegment3DMessage dest)
   {
      dest.set(src);
   }

   @Override
   public void serialize(robotenvironmentawareness_msgs.msg.dds.LineSegment3DMessage data, us.ihmc.pubsub.common.SerializedPayload serializedPayload)
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, robotenvironmentawareness_msgs.msg.dds.LineSegment3DMessage data)
         throws java.io.IOException
   {
