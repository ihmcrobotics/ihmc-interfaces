...
public class LineSegment3DMessage
{
    ...
    {
        	start_ = new us.ihmc.euclid.tuple3D.Point3D32();end_ = new us.ihmc.euclid.tuple3D.Point3D32();        
        
    }

    public void set(LineSegment3DMessage other)
    {
           	geometry_msgs.msg.dds.Point32PubSubType.staticCopy(other.start_, start_);geometry_msgs.msg.dds.Point32PubSubType.staticCopy(other.end_, end_);    }
    ...
    public boolean equals(java.lang.Object other)
    {
        ...
        if(!(other instanceof LineSegment3DMessage)) return false;
