...
public class Odometry
{
    public Odometry()
    {
        	...
        	pose_ = new geometry_msgs.msg.dds.PoseWithCovariance();twist_ = new geometry_msgs.msg.dds.TwistWithCovariance();        
    ...
    public void set(Odometry other)
    {
        	...
        	child_frame_id_.append(other.child_frame_id_);
           	geometry_msgs.msg.dds.PoseWithCovariancePubSubType.staticCopy(other.pose_, pose_);geometry_msgs.msg.dds.TwistWithCovariancePubSubType.staticCopy(other.twist_, twist_);    }
