...
public class TaskspaceTrajectoryStamped
{
    ...
    {
        	header_ = new std_msgs.msg.dds.Header();trajectory_points_stamped_ = new us.ihmc.idl.IDLSequence.Object<geometry_msgs.msg.dds.PoseStamped> (100, geometry_msgs.msg.dds.PoseStamped.class, new geometry_msgs.msg.dds.PoseStampedPubSubType());
    ...
    {
           	std_msgs.msg.dds.HeaderPubSubType.staticCopy(other.header_, header_);trajectory_points_stamped_.set(other.trajectory_points_stamped_);	builtin_interfaces.msg.dds.DurationPubSubType.staticCopy(other.time_from_start_, time_from_start_);
    }
    ...
    public boolean equals(java.lang.Object other)
    {
        ...
        if(!(other instanceof TaskspaceTrajectoryStamped)) return false;
