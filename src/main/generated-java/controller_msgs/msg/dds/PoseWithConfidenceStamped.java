...
public class PoseWithConfidenceStamped
{
    ...
    {
           	geometry_msgs.msg.dds.PoseStampedPubSubType.staticCopy(other.pose_, pose_);confidence_ = other.confidence_;
    ...
    public boolean equals(java.lang.Object other)
    {
        ...
        if(!(other instanceof PoseWithConfidenceStamped)) return false;
