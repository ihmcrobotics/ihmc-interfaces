...
public class AtlasRobotConfigurationData
{
    ...
    {
        	robot_configuration_data_ = new controller_msgs.msg.dds.RobotConfigurationData();atlas_auxiliary_robot_data_ = new controller_msgs.msg.dds.AtlasAuxiliaryRobotData();        
        
    }

    public void set(AtlasRobotConfigurationData other)
    {
           	controller_msgs.msg.dds.RobotConfigurationDataPubSubType.staticCopy(other.robot_configuration_data_, robot_configuration_data_);controller_msgs.msg.dds.AtlasAuxiliaryRobotDataPubSubType.staticCopy(other.atlas_auxiliary_robot_data_, atlas_auxiliary_robot_data_);    }
    ...
    public boolean equals(java.lang.Object other)
    {
        ...
        if(!(other instanceof AtlasRobotConfigurationData)) return false;
