...
public class RobotConfigurationData
{
   ...
   public RobotConfigurationData()
   {
      ...
      moment_and_force_data_all_force_sensors_ = new std_msgs.msg.dds.Float32MultiArray();
      imu_sensor_data_ = new us.ihmc.idl.IDLSequence.Object<controller_msgs.msg.dds.IMUPacket>(100, controller_msgs.msg.dds.IMUPacket.class,
   ...
   public void set(RobotConfigurationData other)
   {
      ...
      std_msgs.msg.dds.Float32MultiArrayPubSubType.staticCopy(other.moment_and_force_data_all_force_sensors_, moment_and_force_data_all_force_sensors_);
