...
public class WeightedJointTrajectory
{
    ...
    {
        	header_ = new std_msgs.msg.dds.Header();joint_names_ = new us.ihmc.idl.IDLSequence.StringBuilderHolder (100, "type_d");   points_ = new us.ihmc.idl.IDLSequence.Object<controller_msgs.msg.dds.WeightedJointTrajectoryPoint> (100, controller_msgs.msg.dds.WeightedJointTrajectoryPoint.class, new controller_msgs.msg.dds.WeightedJointTrajectoryPointPubSubType());
    ...
    {
           	std_msgs.msg.dds.HeaderPubSubType.staticCopy(other.header_, header_);joint_names_.set(other.joint_names_);	points_.set(other.points_);	
    }
    ...
    public boolean equals(java.lang.Object other)
    {
        ...
        if(!(other instanceof WeightedJointTrajectory)) return false;
