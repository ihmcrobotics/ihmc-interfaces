...
public class WeightedJointTrajectoryPoint
{
    ...
    {
           	trajectory_msgs.msg.dds.JointTrajectoryPointPubSubType.staticCopy(other.point_, point_);weight_ = other.weight_;
    ...
    public boolean equals(java.lang.Object other)
    {
        ...
        if(!(other instanceof WeightedJointTrajectoryPoint)) return false;
