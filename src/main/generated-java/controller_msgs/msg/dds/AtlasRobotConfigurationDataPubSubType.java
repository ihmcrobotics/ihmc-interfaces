...
public class AtlasRobotConfigurationDataPubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.AtlasRobotConfigurationData>
{
    ...
    @Override
   public void serialize(controller_msgs.msg.dds.AtlasRobotConfigurationData data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.AtlasRobotConfigurationData data) throws java.io.IOException
   {
	...
	public final static int getCdrSerializedSize(controller_msgs.msg.dds.AtlasRobotConfigurationData data, int current_alignment)
	{
	    ...
	    current_alignment += controller_msgs.msg.dds.AtlasAuxiliaryRobotDataPubSubType.getCdrSerializedSize(data.getAtlas_auxiliary_robot_data(), current_alignment);
