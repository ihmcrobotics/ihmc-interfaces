...
public class AtlasAuxiliaryRobotData
{
    public AtlasAuxiliaryRobotData()
    {
        	...
        	raw_imu_rates_ = new std_msgs.msg.dds.Float32MultiArray();raw_imu_deltas_ = new std_msgs.msg.dds.Float32MultiArray();        
        
    }

    public void set(AtlasAuxiliaryRobotData other)
    {
            electric_joint_temperatures_.set(other.electric_joint_temperatures_);	electric_joint_currents_.set(other.electric_joint_currents_);	electric_joint_enabled_array_.set(other.electric_joint_enabled_array_);	raw_imu_timestamps_.set(other.raw_imu_timestamps_);	raw_imu_packets_counts_.set(other.raw_imu_packets_counts_);	std_msgs.msg.dds.Float32MultiArrayPubSubType.staticCopy(other.raw_imu_rates_, raw_imu_rates_);std_msgs.msg.dds.Float32MultiArrayPubSubType.staticCopy(other.raw_imu_deltas_, raw_imu_deltas_);battery_charging_ = other.battery_charging_;
