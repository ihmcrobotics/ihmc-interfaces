...
public class GoalStatusArray
{
    ...
    {
        	header_ = new std_msgs.msg.dds.Header();status_list_ = new us.ihmc.idl.IDLSequence.Object<actionlib_msgs.msg.dds.GoalStatus> (100, actionlib_msgs.msg.dds.GoalStatus.class, new actionlib_msgs.msg.dds.GoalStatusPubSubType());
    ...
    {
           	std_msgs.msg.dds.HeaderPubSubType.staticCopy(other.header_, header_);status_list_.set(other.status_list_);	
    }
