...
public class MultiDOFJointTrajectoryPubSubType implements us.ihmc.pubsub.TopicDataType<trajectory_msgs.msg.dds.MultiDOFJointTrajectory>
{
   ...
   public final static int getCdrSerializedSize(trajectory_msgs.msg.dds.MultiDOFJointTrajectory data, int current_alignment)
   {
      ...
      {
         current_alignment += trajectory_msgs.msg.dds.MultiDOFJointTrajectoryPointPubSubType.getCdrSerializedSize(data.getPoints().get(a), current_alignment);
      }
   ...
   @Override
   public void serialize(trajectory_msgs.msg.dds.MultiDOFJointTrajectory data, us.ihmc.pubsub.common.SerializedPayload serializedPayload)
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, trajectory_msgs.msg.dds.MultiDOFJointTrajectory data)
         throws java.io.IOException
   {
