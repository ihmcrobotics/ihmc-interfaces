...
public class BatteryState
{
    public BatteryState()
    {
        	header_ = new std_msgs.msg.dds.Header();cell_voltage_ = new us.ihmc.idl.IDLSequence.Float (100, "type_5");
    ...
    {
           	std_msgs.msg.dds.HeaderPubSubType.staticCopy(other.header_, header_);voltage_ = other.voltage_;
            ...
            cell_voltage_.set(other.cell_voltage_);	location_.setLength(0);
