...
public class TimeReference
{
    ...
    {
        	header_ = new std_msgs.msg.dds.Header();time_ref_ = new builtin_interfaces.msg.dds.Time();source_ = new java.lang.StringBuilder(255); 
    ...
    {
           	std_msgs.msg.dds.HeaderPubSubType.staticCopy(other.header_, header_);builtin_interfaces.msg.dds.TimePubSubType.staticCopy(other.time_ref_, time_ref_);source_.setLength(0);
