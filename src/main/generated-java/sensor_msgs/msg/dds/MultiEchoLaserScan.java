...
public class MultiEchoLaserScan
{
    ...
    {
        	header_ = new std_msgs.msg.dds.Header();ranges_ = new us.ihmc.idl.IDLSequence.Object<sensor_msgs.msg.dds.LaserEcho> (100, sensor_msgs.msg.dds.LaserEcho.class, new sensor_msgs.msg.dds.LaserEchoPubSubType());
    ...
    {
           	std_msgs.msg.dds.HeaderPubSubType.staticCopy(other.header_, header_);angle_min_ = other.angle_min_;
