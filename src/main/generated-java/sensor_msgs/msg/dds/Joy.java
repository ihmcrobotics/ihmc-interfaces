...
public class Joy
{
    public Joy()
    {
        	header_ = new std_msgs.msg.dds.Header();axes_ = new us.ihmc.idl.IDLSequence.Float (100, "type_5");
    ...
    {
           	std_msgs.msg.dds.HeaderPubSubType.staticCopy(other.header_, header_);axes_.set(other.axes_);	buttons_.set(other.buttons_);	
    }
    ...
    public boolean equals(java.lang.Object other)
    {
        ...
        if(!(other instanceof Joy)) return false;
