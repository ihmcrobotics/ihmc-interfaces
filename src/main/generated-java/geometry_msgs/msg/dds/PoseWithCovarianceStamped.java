...
public class PoseWithCovarianceStamped
{
    ...
    {
        	header_ = new std_msgs.msg.dds.Header();pose_ = new geometry_msgs.msg.dds.PoseWithCovariance();        
        
    }

    public void set(PoseWithCovarianceStamped other)
    {
           	std_msgs.msg.dds.HeaderPubSubType.staticCopy(other.header_, header_);geometry_msgs.msg.dds.PoseWithCovariancePubSubType.staticCopy(other.pose_, pose_);    }
