...
public class DiagnosticStatus
{
    public DiagnosticStatus()
    {
        	...
        	values_ = new us.ihmc.idl.IDLSequence.Object<diagnostic_msgs.msg.dds.KeyValue> (100, diagnostic_msgs.msg.dds.KeyValue.class, new diagnostic_msgs.msg.dds.KeyValuePubSubType());
