...
public class ImageMarkerPubSubType implements us.ihmc.pubsub.TopicDataType<visualization_msgs.msg.dds.ImageMarker>
{
   ...
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, visualization_msgs.msg.dds.ImageMarker data) throws java.io.IOException
   {
	...
	public final static int getCdrSerializedSize(visualization_msgs.msg.dds.ImageMarker data, int current_alignment)
	{
	    ...
	    current_alignment += std_msgs.msg.dds.ColorRGBAPubSubType.getCdrSerializedSize(data.getOutline_color(), current_alignment);
	    current_alignment += 1 + us.ihmc.idl.CDR.alignment(current_alignment, 1);

	    current_alignment += std_msgs.msg.dds.ColorRGBAPubSubType.getCdrSerializedSize(data.getFill_color(), current_alignment);
	    ...
	    current_alignment += 4 + us.ihmc.idl.CDR.alignment(current_alignment, 4);
	    for(int a = 0; a < data.getOutline_colors().size(); ++a)
	    {
	        current_alignment += std_msgs.msg.dds.ColorRGBAPubSubType.getCdrSerializedSize(data.getOutline_colors().get(a), current_alignment);}
   ...
   public static void write(visualization_msgs.msg.dds.ImageMarker data, us.ihmc.idl.CDR cdr)
   {
	    ...
	    std_msgs.msg.dds.ColorRGBAPubSubType.write(data.getOutline_color(), cdr);

	    cdr.write_type_9(data.getFilled());

	    std_msgs.msg.dds.ColorRGBAPubSubType.write(data.getFill_color(), cdr);
	    ...
	    if(data.getOutline_colors().size() <= 100)
	    cdr.write_type_e(data.getOutline_colors());else
   ...
   public static void read(visualization_msgs.msg.dds.ImageMarker data, us.ihmc.idl.CDR cdr)
   {
	    	...
	    	std_msgs.msg.dds.ColorRGBAPubSubType.read(data.getOutline_color(), cdr);	

	    	data.setFilled(cdr.read_type_9());
	    	

	    	std_msgs.msg.dds.ColorRGBAPubSubType.read(data.getFill_color(), cdr);	

	    	builtin_interfaces.msg.dds.DurationPubSubType.read(data.getLifetime(), cdr);	

	    	cdr.read_type_e(data.getPoints());	

	    	cdr.read_type_e(data.getOutline_colors());	
   }
	...
	public final void serialize(visualization_msgs.msg.dds.ImageMarker data, us.ihmc.idl.InterchangeSerializer ser)
	{
			    ...
			    ser.write_type_a("outline_color", new std_msgs.msg.dds.ColorRGBAPubSubType(), data.getOutline_color());

			    
			    ser.write_type_9("filled", data.getFilled());
			    
			    ser.write_type_a("fill_color", new std_msgs.msg.dds.ColorRGBAPubSubType(), data.getFill_color());
	...
	public final void deserialize(us.ihmc.idl.InterchangeSerializer ser, visualization_msgs.msg.dds.ImageMarker data)
	{
	    			...
	    			ser.read_type_a("outline_color", new std_msgs.msg.dds.ColorRGBAPubSubType(), data.getOutline_color());
	    	
	    	    
	    			data.setFilled(ser.read_type_9("filled"));	
	    	    
	    			ser.read_type_a("fill_color", new std_msgs.msg.dds.ColorRGBAPubSubType(), data.getFill_color());
