...
public class OccupancyGrid
{
    ...
    {
        	header_ = new std_msgs.msg.dds.Header();info_ = new nav_msgs.msg.dds.MapMetaData();data_ = new us.ihmc.idl.IDLSequence.Byte (100, "type_9");
    ...
    {
           	std_msgs.msg.dds.HeaderPubSubType.staticCopy(other.header_, header_);nav_msgs.msg.dds.MapMetaDataPubSubType.staticCopy(other.info_, info_);data_.set(other.data_);	
    }
