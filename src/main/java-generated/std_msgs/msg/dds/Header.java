...
public class Header
{
    public Header()
    {
        	stamp_ = new builtin_interfaces.msg.dds.Time();frame_id_ = new java.lang.StringBuilder(255); 
    ...
    {
           	builtin_interfaces.msg.dds.TimePubSubType.staticCopy(other.stamp_, stamp_);frame_id_.setLength(0);
