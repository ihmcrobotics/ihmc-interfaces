...
public class PointCloud2
{
    public PointCloud2()
    {
        	header_ = new std_msgs.msg.dds.Header();fields_ = new us.ihmc.idl.IDLSequence.Object<sensor_msgs.msg.dds.PointField> (100, sensor_msgs.msg.dds.PointField.class, new sensor_msgs.msg.dds.PointFieldPubSubType());
    ...
    public void set(PointCloud2 other)
    {
        	...
        	width_ = other.width_;
            fields_.set(other.fields_);	is_bigendian_ = other.is_bigendian_;
