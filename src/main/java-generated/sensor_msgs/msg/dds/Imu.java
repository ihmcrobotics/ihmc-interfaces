...
public class Imu
{
    ...
    {
           	std_msgs.msg.dds.HeaderPubSubType.staticCopy(other.header_, header_);geometry_msgs.msg.dds.QuaternionPubSubType.staticCopy(other.orientation_, orientation_);for(int b = 0; b < orientation_covariance_.length; ++b)
        	{
        	    	orientation_covariance_[b] = other.orientation_covariance_[b];	

        	}
        	
           	geometry_msgs.msg.dds.Vector3PubSubType.staticCopy(other.angular_velocity_, angular_velocity_);for(int d = 0; d < angular_velocity_covariance_.length; ++d)
        	{
        	    	angular_velocity_covariance_[d] = other.angular_velocity_covariance_[d];	

        	}
        	
           	geometry_msgs.msg.dds.Vector3PubSubType.staticCopy(other.linear_acceleration_, linear_acceleration_);for(int f = 0; f < linear_acceleration_covariance_.length; ++f)
        	{
