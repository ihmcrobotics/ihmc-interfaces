...
public class CompressedImage
{
    ...
    {
        	header_ = new std_msgs.msg.dds.Header();format_ = new java.lang.StringBuilder(255); 
    ...
    {
           	std_msgs.msg.dds.HeaderPubSubType.staticCopy(other.header_, header_);format_.setLength(0);
