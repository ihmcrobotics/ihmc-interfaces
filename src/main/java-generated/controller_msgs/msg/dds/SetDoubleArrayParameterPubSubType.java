...
public class SetDoubleArrayParameterPubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.SetDoubleArrayParameter>
{
    ...
    @Override
   public void serialize(controller_msgs.msg.dds.SetDoubleArrayParameter data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.SetDoubleArrayParameter data) throws java.io.IOException
   {
