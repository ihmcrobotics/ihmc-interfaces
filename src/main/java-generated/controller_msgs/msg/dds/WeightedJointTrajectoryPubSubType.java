...
public class WeightedJointTrajectoryPubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.WeightedJointTrajectory>
{
    ...
    @Override
   public void serialize(controller_msgs.msg.dds.WeightedJointTrajectory data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.WeightedJointTrajectory data) throws java.io.IOException
   {
   ...
   public static void write(controller_msgs.msg.dds.WeightedJointTrajectory data, us.ihmc.idl.CDR cdr)
   {
	    ...
	    cdr.write_type_e(data.getJoint_names());else
