...
public class SetBooleanParameterPubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.SetBooleanParameter>
{
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.SetBooleanParameter data) throws java.io.IOException
   {
