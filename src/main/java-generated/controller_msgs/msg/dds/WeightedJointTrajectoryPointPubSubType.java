...
public class WeightedJointTrajectoryPointPubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.WeightedJointTrajectoryPoint>
{
    ...
    @Override
   public void serialize(controller_msgs.msg.dds.WeightedJointTrajectoryPoint data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.WeightedJointTrajectoryPoint data) throws java.io.IOException
   {
