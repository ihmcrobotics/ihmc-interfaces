...
public class PoseWithConfidenceStampedPubSubType implements us.ihmc.pubsub.TopicDataType<controller_msgs.msg.dds.PoseWithConfidenceStamped>
{
    ...
    @Override
   public void serialize(controller_msgs.msg.dds.PoseWithConfidenceStamped data, us.ihmc.pubsub.common.SerializedPayload serializedPayload) throws java.io.IOException
   {
   ...
   @Override
   public void deserialize(us.ihmc.pubsub.common.SerializedPayload serializedPayload, controller_msgs.msg.dds.PoseWithConfidenceStamped data) throws java.io.IOException
   {
