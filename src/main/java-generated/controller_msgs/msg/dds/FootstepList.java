...
public class FootstepList
{
    public FootstepList()
    {
        	footsteps_ = new us.ihmc.idl.IDLSequence.Object<controller_msgs.msg.dds.Footstep> (100, controller_msgs.msg.dds.Footstep.class, new controller_msgs.msg.dds.FootstepPubSubType());
    ...
    public void set(FootstepList other)
    {
            ...
            footsteps_.set(other.footsteps_);	executing_timing_ = other.executing_timing_;
    ...
    public boolean equals(java.lang.Object other)
    {
        ...
        if(!(other instanceof FootstepList)) return false;
