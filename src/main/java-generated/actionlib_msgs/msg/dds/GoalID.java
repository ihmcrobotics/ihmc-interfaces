...
public class GoalID
{
    public GoalID()
    {
        	stamp_ = new builtin_interfaces.msg.dds.Time();id_ = new java.lang.StringBuilder(255); 
    ...
    {
           	builtin_interfaces.msg.dds.TimePubSubType.staticCopy(other.stamp_, stamp_);id_.setLength(0);
