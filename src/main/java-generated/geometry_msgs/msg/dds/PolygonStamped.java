...
public class PolygonStamped
{
    ...
    {
        	header_ = new std_msgs.msg.dds.Header();polygon_ = new geometry_msgs.msg.dds.Polygon();        
        
    }

    public void set(PolygonStamped other)
    {
           	std_msgs.msg.dds.HeaderPubSubType.staticCopy(other.header_, header_);geometry_msgs.msg.dds.PolygonPubSubType.staticCopy(other.polygon_, polygon_);    }
