...
public class TwistWithCovariance
{
    ...
    {
        	twist_ = new geometry_msgs.msg.dds.Twist();covariance_ = new double[36];
    ...
    {
           	geometry_msgs.msg.dds.TwistPubSubType.staticCopy(other.twist_, twist_);for(int b = 0; b < covariance_.length; ++b)
        	{
