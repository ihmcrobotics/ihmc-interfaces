...
public class WrenchStamped
{
    ...
    {
        	header_ = new std_msgs.msg.dds.Header();wrench_ = new geometry_msgs.msg.dds.Wrench();        
        
    }

    public void set(WrenchStamped other)
    {
           	std_msgs.msg.dds.HeaderPubSubType.staticCopy(other.header_, header_);geometry_msgs.msg.dds.WrenchPubSubType.staticCopy(other.wrench_, wrench_);    }
    ...
    public boolean equals(java.lang.Object other)
    {
        ...
        if(!(other instanceof WrenchStamped)) return false;
