...
public class QuaternionStamped
{
    ...
    {
           	std_msgs.msg.dds.HeaderPubSubType.staticCopy(other.header_, header_);geometry_msgs.msg.dds.QuaternionPubSubType.staticCopy(other.quaternion_, quaternion_);    }
